...
This document assumes that you have Ubuntu 18.04 LTS installed on a separate machine.  Ubuntu 18.04 LTS can obviously be installed on a VM to Windows 10, but there is a possible added complication of the bridge adapter between the two operating systems that I will not have encountered

 

The overall steps to root the DJA0230 device are listed below, and details for each of the steps follows.
